...
| `WEB_UI_HOST`                            | `true`                                                           | Starts the local web UI server when set to `true`. Set it to `false` to disable the crawl monitor and final audit summary pages.                                                                                                                                                                                     |
| `WEB_UI_PORT`                               | `3000`                                                           | TCP port used by the local web UI server. Set to `0` to disable it implicitly.                                                                                                                                                                                                                                       |
| `WEB_UI_HOST`                               | `127.0.0.1`                                                      | Host interface used by the local web UI server.                                                                                                                                                                                                                                                                      |
