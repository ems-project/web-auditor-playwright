...
| `FRAME_WAIT_TIMEOUT_MS`                     | `3000`                                                           | Maximum time (in milliseconds) to wait for iframe elements to attach to the page using event-based detection.                                                                                                                                                                                                        |
| `FRAME_LOAD_TIMEOUT_MS`                     | `5000`                                                           | Maximum time (in milliseconds) to wait for iframe content to finish loading after attachment.                                                                                                                                                                                                                        |
...
| `BLOCK_NOFOLLOW`                            | `false`                                                          | If enabled, links with `rel="nofollow"` attribute will not be crawled or analyzed. This respects the nofollow directive commonly used to indicate that search engines should not follow the link.                                                                                                                    |
...
| `REPORT_MAX_ISSUES`                         | `1000`                                                           | Limit the reports to the first X issues (in order to avoid memory issues)                                                                                                                                                                                                                                            |
