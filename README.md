...
| `CSS_MAX_INLINE_STYLE_ATTRIBUTES`           | `25`                                                             | Warns when a page contains more inline `style` attributes than this threshold.                                                                                                                                                                                                                                       |
| `CSS_MAX_STYLE_TAGS`                        | `5`                                                              | Warns when a page contains more `<style>` tags than this threshold.                                                                                                                                                                                                                                                  |
